...
def crawl(url):
    with sync_playwright() as p:
        ...
        try:
            ...
            raw_steps = raw_data.get("Trình tự thực hiện", "")
            steps_list = [step.strip() for step in raw_steps.split('\n') if step.strip()] if raw_steps else []
            ...
            output_filename = f"metadata_{proc_id}.json"
...
if __name__ == "__main__":
    test_url = "https://dichvucong.gov.vn/thu-tuc-hanh-chinh/019d2bfd-3fe0-70ac-b9d6-5e9e20d6eef7"
    crawl(test_url)
"""Demo pipeline đến bước mở rộng quan hệ bằng Neo4j."""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Demo RAG đến Neo4j retrieval.")
    ...
    procedure_ids = [chunk.doc_id for chunk in vector_result["procedures"]]
    ...
    print(
        json.dumps(
            {
                "seed_procedure_ids": list(dict.fromkeys(procedure_ids)),
